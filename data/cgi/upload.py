...
def save_uploaded_file(file_item):
    upload_dir = '/home/ael-bako/Desktop/vasper_latest/data/cgi/uploads/'  # Set the directory where you want to store uploaded files
    ...
    if "uploaded_file" in form:
        ...
        if file_item.filename:
            try:
                ...
                print("File Size: " + str(os.path.getsize('/home/ael-bako/Desktop/vasper_latest/data/cgi/uploads/' + file_name)) + " bytes<br>")
